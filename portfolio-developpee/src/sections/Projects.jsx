...
export default function Projects() {
  return <section id="work" className="section shell">
    <Reveal><p className="kicker">01 — Selected Work</p><div className="section-heading"><h2>Projects built with purpose.</h2><p>Mes projets publics en développement logiciel, web, données et applications collaboratives.</p></div></Reveal>
